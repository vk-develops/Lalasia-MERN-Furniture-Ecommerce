const styles = {
    navLink: "font-eduoxusSans text-sm font-medium",
    layout: "max-w-5xl mx-auto p-5",
    navButton: `px-4 py-3 bg-primaryColor inline-block text-screenColor1 font-eduoxusSans font-medium text-sm max-mobile:text-xs`,
    headingText:
